...
class WidgetWithValueState:
    ...
    class, returning the ``value()`` field.
    """
    def get_state(self):
        return self.value()


class StrLenSpinBox(IntSpinBox, WidgetWithValueState):
    """
    """
    def __init__(self, parent, default):
        """
        """
        super().__init__(parent, minimum=0, default=default, suffix=" chars")


class SamplerateSpinBox(IntSpinBox, WidgetWithValueState):
    """
    """
    def __init__(self, parent, default):
        """
        """
        super().__init__(parent, minimum=0, default=default, suffix="Hz")
...
class NamedForm(QtWidgets.QWidget):
    ...
    def __init__(self, form_name, form_param_nwd, parent=None):
        """
        ...
        :param form_param_nwd: A list of parameters in the form
          ``(name, widget_fn, default)``. The widget_fn must accept
    ...
    def get_parameter_form(cls, nwd_list):
        ...
        for pname, w_fn, pdefault in nwd_list:
            qobj = w_fn(parent=None, default=pdefault)
