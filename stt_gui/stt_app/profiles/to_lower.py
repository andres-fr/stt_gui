...
# ## WORKER
# #############################################################################
class ToLowerWorker(ProfileWorker):
    """
    """
    def run(self, text):
        result = text.lower()
